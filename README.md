...
Models
 ...
 Best Model: XGBoost
  ...
  R2 (Test): It has the highest R2 (Test) value (0.814), meaning it explains the most variance in the test data compared 
     to other models.
  Adjusted R2 (Test): It has the highest Adjusted R2 (Test) (0.609), reflecting its performance adjusted for the number of 
    predictors.
